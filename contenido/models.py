...
class  gamespc(models.Model):
    ...
    img1=models.ImageField(verbose_name="Subir Imagen 1")
    img2=models.ImageField(verbose_name="Subir Imagen 2")
    img3=models.ImageField(verbose_name="Subir Imagen 3")
    img4=models.ImageField(verbose_name="Subir Imagen 4")
    img5=models.ImageField(verbose_name="Subir Imagen 5")
